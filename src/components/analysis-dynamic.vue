<template>
  <div>
    <div>
      <q-list>
        <q-item>
          <q-item-side>Days to Expiration Offset #</q-item-side>
          <q-item-main>
            <q-field helper="price increment between points">
              <q-slider
                ...
                label
                snap
                @change="val => { dteOffset = val }"
              />
            </q-field>
          </q-item-main>
        </q-item>
        <q-item>
          <q-item-side>Volatility Offset %</q-item-side>
          <q-item-main>
            <q-field helper="number of price increments to plot">
              <q-slider
                ...
                :max="100"
                :step="1"
                :value="volatilityOffset"
                snap
                label-always
                label
                @change="val => { volatilityOffset = val }"
              />
            </q-field>
          </q-item-main>
        </q-item>
...
export default {
  ...
  computed: {
    ...
    volatilityOffset: {
      get() {
        return this.$store.state.optionstrategy.volatilityOffset;
      },
      set(val) {
        this.$store.commit('optionstrategy/SET_VOL_OFFSET', val);
      },
    },
    dteOffset: {
      get() {
        return this.$store.state.optionstrategy.dteOffset;
      },
      set(val) {
        this.$store.commit('optionstrategy/SET_DTE_OFFSET', val);
      },
    },
  ...
  methods: {
    test() {
      console.log(this.volatilityOffset);
    },
